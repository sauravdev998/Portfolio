...
"Portfolio OS" — a macOS-style desktop portfolio in the browser. Each portfolio section (About, Projects, Resume, Contact, Terminal, Snake, Trash) is an "app" opened in a draggable window.
